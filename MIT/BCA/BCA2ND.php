...
<body>
    ...
    <div class="header">
        <h1>BCA 2ND Year Papers</h1>
        <p>Click on a paper to view details and resources</p>
    </div>
    <div class="section">
        <ul class="paper-list">
            <li><a href="http://localhost/mit/BCA/paper/cn.html"><i class="fas fa-network-wired"></i> Computer Network</a></li>
            <li><a href="http://localhost/mit/BCA/paper/oat.html"><i class="fas fa-desktop"></i> Office Automation Tools</a></li>
            <li><a href="http://localhost/mit/BCA/paper/cbnt.html"><i class="fas fa-calculator"></i> Computer Based Numerical Technique</a></li>
            <li><a href="http://localhost/mit/BCA/paper/sad.html"><i class="fas fa-cogs"></i> System Analysis and Design</a></li>
            <li><a href="http://localhost/mit/BCA/paper/os.html"><i class="fab fa-linux"></i> Operating System</a></li>
            <li><a href="http://localhost/mit/BCA/paper/se.html"><i class="fas fa-code"></i> Software Engineering</a></li>
            <li><a href="http://localhost/mit/BCA/paper/mm.html"><i class="fas fa-film"></i> Multimedia</a></li>
            <li><a href="http://localhost/mit/BCA/paper/ba.html"><i class="fas fa-microchip"></i> Boolean Algebra</a></li>
        </ul>
    </div>
