...
<body>
    ...
    <div class="header">
        <h1>BCA 3RD Year Papers</h1>
        <p>Click on a paper to view details and resources</p>
    </div>
    <div class="section">
        <ul class="paper-list">
            <li><a href="http://localhost/mit/BCA/paper/wt.html"><i class="fas fa-globe"></i> Web Technology</a></li>
            <li><a href="http://localhost/mit/BCA/paper/plsql.html"><i class="fas fa-database"></i> PL/SQL</a></li>
            <li><a href="http://localhost/mit/BCA/paper/dpc.html"><i class="fas fa-network-wired"></i> Distributed System</a></li>
            <li><a href="http://localhost/mit/BCA/paper/st.html"><i class="fas fa-cogs"></i> Software Testing</a></li>
            <li><a href="http://localhost/mit/BCA/paper/php.html"><i class="fab fa-php"></i> PHP Programming</a></li>
            <li><a href="http://localhost/mit/BCA/paper/spm.html"><i class="fas fa-code"></i> Software Project Model</a></li>
            <li><a href="http://localhost/mit/BCA/paper/uml.html"><i class="fas fa-diagnoses"></i> Unified Modeling Language</a></li>
        </ul>
    </div>
