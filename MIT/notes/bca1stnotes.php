...
<body>
    ...
    <div class="wrap-bca-it">
        ...
        <div class="bca-year-section">
            ...
            <div class="bca-year-subpart">
                ...
                <a href="http://localhost/mit/notes/bca2ndnotes.php" class="button">Click Here</a>
            </div>
            <div class="bca-year-subpart">
                <i class="fas fa-graduation-cap icon"></i>
    ...
    <div class="header">
        ...
        <p>Click on a NOTES to view details and resources</p>
    </div>
    <div class="section">
        <ul class="paper-list">
            <li><a href="#"><i class="fas fa-code"></i> Programming in C</a></li>
            <li><a href="#"><i class="fas fa-desktop"></i> Fundamental of Computer</a></li>
            <li><a href="#"><i class="fas fa-comments"></i> English Communication</a></li>
            <li><a href="#"><i class="fas fa-calculator"></i> Mathematics</a></li>
            <li><a href="#"><i class="fas fa-database"></i> Data Structure and Algorithm</a></li>
            <li><a href="#"><i class="fas fa-cogs"></i> OOPs in C++</a></li>
            <li><a href="#"><i class="fas fa-leaf"></i> Environment Studies</a></li>
            <li><a href="#"><i class="fas fa-database"></i> Database Management System</a></li>
        </ul>
    </div>
