...
<body>
    ...
    <div class="navbar-div">
        ...
        <div class="name-college">
            <a href="http://localhost/mit/mitlogo.png" style="text-decoration: none;">
    ...
    <div class="wrap-bca-it">
        ...
        <div class="bca-year-section">
            ...
            <div class="bca-year-subpart">
                ...
                <p>AAccess notes for the first year of BCA program.</p>
                <a href="http://localhost/mit/notes/bca1stnotes.php" class="button">Click Here</a>
            </div>
            <div class="bca-year-subpart">
                <i class="fas fa-graduation-cap icon"></i>
                <h2>BCA 3RD YEAR NOTES</h2>
                <p>Access notes for the third year of BCA program.</p>
                <a href="http://localhost/mit/notes/bca3rdnotes.php" class="button">Click Here</a>
            </div>
    ...
    <div class="header">
        <h1>BCA 2ND Year Notes</h1>
        <p>Click on a subject to view details and resources</p>
    </div>
    <div class="section">
        <ul class="paper-list">
            <li><a href="#"><i class="fas fa-network-wired"></i> Computer Network</a></li>
            <li><a href="#"><i class="fas fa-desktop"></i> Office Automation Tools</a></li>
            <li><a href="#"><i class="fas fa-calculator"></i> Computer Based Numerical Statics</a></li>
            <li><a href="#"><i class="fas fa-cogs"></i> System Analysis and Design</a></li>
            <li><a href="#"><i class="fab fa-linux"></i> Operating System</a></li>
            <li><a href="#"><i class="fas fa-code"></i> Software Engineering</a></li>
            <li><a href="#"><i class="fas fa-film"></i> Multimedia</a></li>
            <li><a href="#"><i class="fas fa-microchip"></i> Boolean Algebra</a></li>
        </ul>
    </div>
