...
<body>
    ...
    <div class="wrap-bca-it">
        ...
        <div class="bca-year-section">
            ...
            <div class="bca-year-subpart">
                ...
                <p>"Unveiling Potential: Unleashing Innovation and Leadership in BCA's Final Year"</p>
    ...
    <div class="header">
        <h1>BCA 1st Year Learning</h1>
        <p>Click on a subject to view and read online</p>
    </div>
    <div class="section">
        <ul class="paper-list">
            <li><a href="http://localhost/mit/learning/BCA/1styear/c.html"><i class="fas fa-code"></i> Programming in C <span>(Learn)</span></a></li>
            <li><a href=""><i class="fas fa-desktop"></i> Fundamental of Computer <span>(Learn)</span></a></li>
            <li><a href=""><i class="fas fa-comments"></i> English Communication <span>(Learn)</span></a></li>
            <li><a href=""><i class="fas fa-calculator"></i> Mathematics <span>(Learn)</span></a></li>
            <li><a href=""><i class="fas fa-database"></i> Data Structure and Algorithm <span>(Learn)</span></a></li>
            <li><a href=""><i class="fas fa-cogs"></i> OOPs in C++ <span>(Learn)</span></a></li>
            <li><a href=""><i class="fas fa-leaf"></i> Environment Studies <span>(Learn)</span></a></li>
            <li><a href=""><i class="fas fa-database"></i> Database Management System <span>(Learn)</span></a></li>
        </ul>
    </div>
