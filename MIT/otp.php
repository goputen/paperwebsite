...
<?php
   ...
   if($password!=$cpassword){
    echo "<script>alert('password must be match');</script>";
   ...
   $sql = "INSERT INTO users (fullname, email, password, otp) VALUES ('$fullname', '$email', '$password', '$otp')";
...
<body>
  <div class="otp-verification-container">
    <div class="otp-verification-header">
      ...
      <p>An OTP has been sent to your Email. Please enter the OTP below to confirm it is you.</p>
    </div>
